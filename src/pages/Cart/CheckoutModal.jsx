            ...
            <div className="relative bg-white w-full max-w-lg rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                <div className="p-8">
                    <div className="flex justify-between items-center mb-8">
                        <h2 className="text-2xl font-bold italic tracking-tighter">CHECKOUT</h2>
                    ...
                    <form className="space-y-5" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="space-y-4">
                            <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Yetkazib berish</label>
                            <input 
                                type="text" 
                            ...
                            <input 
                                type="text" 
                                placeholder="Manzil (Shahar, Ko'cha, Uy)" 
                                className="w-full border-b border-gray-200 py-3 focus:border-black outline-none transition-colors text-lg"
                            />
                        </div>
                        ...
                        <div className="space-y-4 pt-4">
                            <label className="text-xs font-bold uppercase tracking-widest text-gray-400">To'lov usuli</label>
                        ...
                        <div className="pt-8">
                            <div className="flex justify-between items-center mb-6">
                                <span className="text-gray-500 font-medium">To'lov miqdori:</span>
                            ...
                            <button 
                                ...
                                onClick={() => alert("To'lov muvaffaqiyatli amalga oshirildi! 🚀")}
                            >
